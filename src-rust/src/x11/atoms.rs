...
impl Atom {
    pub fn name(&self) -> &'static str {
        match self {
            ...
            Atom::RustboxWindow => "_RUSTBOX_WINDOW",
            Atom::RustboxWindowHidden => "_RUSTBOX_WINDOW_HIDDEN",
            Atom::RustboxRemote => "Rustbox/remote",
            Atom::RustboxRemoteCmd => "RUSTBOX_REMOTE_CMD",
            Atom::RustboxDialog => "_RUSTBOX_DIALOG",
            Atom::Manager => "MANAGER",
            Atom::Xembed => "_XEMBED",
            Atom::XembedInfo => "_XEMBED_INFO",
            Atom::NetSystemTrayS0 => "_NET_SYSTEM_TRAY_S0",
            Atom::NetSystemTrayOpcode => "_NET_SYSTEM_TRAY_OPCODE",
            Atom::NetSystemTrayOrientation => "_NET_SYSTEM_TRAY_ORIENTATION",
            Atom::NetSystemTrayVisual => "_NET_SYSTEM_TRAY_VISUAL",
...
impl AtomCache {
    ...
    pub fn init<C: Connection>(&mut self, conn: &C) -> Result<(), anyhow::Error> {
        let atoms: Vec<Atom> = vec![
            ...
            Atom::RustboxWindow, Atom::RustboxWindowHidden, Atom::RustboxRemote,
            Atom::RustboxRemoteCmd, Atom::RustboxDialog,
            Atom::Manager, Atom::Xembed, Atom::XembedInfo,
            Atom::NetSystemTrayS0, Atom::NetSystemTrayOpcode,
            Atom::NetSystemTrayOrientation, Atom::NetSystemTrayVisual,
